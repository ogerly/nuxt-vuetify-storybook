...
import OcelotLogo150 from "/ocelot-150px.png";
import OcelotLogo from "/ocelot-storybook.png";
import OcelotLogoDocsify from "/docsify-logo-ocelot-150px.png";

<Meta title="Configure your project" />

# Configure your Ocelot project
...
<div className="sb-section-item">
  <img src={OcelotLogoDocsify} alt="Ocelot - Social Network Logo" />
  <div className="sb-block">
    <h3>Ocelot documentation</h3>
    <p>Ein Social Network.</p>
    <a
      href="https://ocelot-social-community.github.io/ocelot-future/#/"
      target="_blank"
    >
...
# Explore and Connect Ocelot

Connect with our Ocelot community on Discord or start contributing directly on Github. You might also be interesting in watching some videos on Youtube explaining how to take full advantage of Storybook.
...
<div className="sb-section">
  <div className="sb-card-grid-container">
    <a
      ...
      href="https://discord.gg/qCXdMxdh"
      target="_blank"
    >
    ...
    <a
      className="sb-explore-card"
      href="https://github.com/Ocelot-Social-Community/ocelot-future"
      target="_blank"
    >
